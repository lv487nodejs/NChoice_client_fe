describe('filter', () => {
  it(' filter items should be visible', () => {
    ...
    cy.get(':nth-child(2) > ul > :nth-child(1) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(2) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(3) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(4) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(5) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(6) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(7) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(8) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(9) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(2) > ul > :nth-child(10) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(3) > ul > :nth-child(1) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(3) > ul > :nth-child(2) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(3) > ul > :nth-child(3) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(3) > ul > :nth-child(4) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(3) > ul > :nth-child(5) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(3) > ul > :nth-child(6) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(3) > ul > :nth-child(7) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(4) > ul > :nth-child(1) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(4) > ul > :nth-child(2) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(4) > ul > :nth-child(3) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(4) > ul > :nth-child(4) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(4) > ul > :nth-child(5) > .list-group-item').should(
      'be.visible'
    );
    cy.get(':nth-child(4) > ul > :nth-child(6) > .list-group-item').should(
      'be.visible'
    );
  });
