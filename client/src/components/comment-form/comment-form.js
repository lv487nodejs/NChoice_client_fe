...
const CommentForm = ({
  ...
  const logged = (
    ...
    >
      ...
      <div className='star'><h6 className='rate'> Rate the product: </h6> <StarsRating rating={rate} id={productId} userId={userId} readonly={false} color="black" isSelectable={true}/></div>
