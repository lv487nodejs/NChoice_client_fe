    ...
    <div className='cotton-container'>
      ...
      <div>
        ...
        >
          <div className='hemp-description'>
            <p className='hemp-p'>
              Hemp has been used to make fabric for thousands of years. It’s one
              of the most sustainable fibres in the world, and an excellent
              alternative to linen. We’ve been using hemp in our collections
              since 1995.
            </p>
            <p className='hemp-p'>
