        ...
        <div className='materials-box'>
            ...
            <div className='cotton-container'>
                ...
                <div className='cotton-images'>
                    <div className='material-img' style={{ backgroundImage: 'url(/images/materials-photo/cotton1.webp)' }}>
                    ...
                    <div className='material-img' style={{ backgroundImage: 'url(/images/materials-photo/cotton5.webp)' }}>
                        <div className='cotton-description'>We only use organic cotton which not only saves water, it's never grown with any pesticides, herbicides or insecticides.</div>
                    </div>
                    <div className='material-img' style={{ backgroundImage: 'url(/images/materials-photo/cotton3.webp)' }}>
                        <div className='cotton-description'>We only use organic cotton which not only saves water, it's never grown with any pesticides, herbicides or insecticides.</div>
                    </div>
                </div>
                ...
                <div className='hemp-img' style={{ backgroundImage: 'url(/images/materials-photo/jute2.webp)' }}>
                ...
                <div className='wool-bottom'>
                    <div className='material-img' style={{ backgroundImage: 'url(/images/materials-photo/wool.webp)' }}></div>
                    ...
                    <div className='material-img' style={{ backgroundImage: 'url(/images/materials-photo/wool3.webp)' }}></div>
                </div>
                ...
                <div >
                    <div className='hemp-img' style={{ backgroundImage: 'url(/images/materials-photo/hemp4.webp)' }}>
                        <div className='hemp-description'>
                ...
                <div className='silk-images'>
                    <div className='material-img' style={{ backgroundImage: 'url(/images/materials-photo/silk4.webp)' }}>
                    ...
                    <div className='material-img' style={{ backgroundImage: 'url(/images/materials-photo/silk3.webp)' }}>
                        <div className='cotton-description'>Silk is not in endless supply and it is still extremely complicated to produce. </div>
                    </div>
                    <div className='material-img' style={{ backgroundImage: 'url(/images/materials-photo/silk6.webp)' }}>
                ...
                <div className='recycled-images' style={{ backgroundImage: 'url(/images/materials-photo/recycled1.webp)' }}>
