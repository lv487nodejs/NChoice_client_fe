      ...
      <div className="cotton-container">
        ...
        <div className="cotton-images">
          <div
            ...
            style={{
              backgroundImage: 'url(/images/materials-photo/cotton1.jpg)'
            }}
          >
            <div className="cotton-description">
              We only use organic cotton which not only saves water, it's never
              grown with any pesticides, herbicides or insecticides.
            </div>
          </div>
          <div
            className="material-img"
            style={{
              backgroundImage: 'url(/images/materials-photo/cotton5.jpg)'
            }}
          >
            <div className="cotton-description">
              We only use organic cotton which not only saves water, it's never
          ...
          <div
            className="material-img"
            style={{
              backgroundImage: 'url(/images/materials-photo/cotton3.jpg)'
            }}
          >
            <div className="cotton-description">
              We only use organic cotton which not only saves water, it's never
        ...
        <div
          className="hemp-img"
          style={{ backgroundImage: 'url(/images/materials-photo/jute2.jpg)' }}
        >
          <div className="hemp-description">
            <p className="hemp-p">
              Natural jute fabric is one of the most useful materials in the
              world after cotton.{' '}
            </p>
            <p className="hemp-p">
              <span className="bold-text"> 85%</span>
              <br></br> of the world’s jute production is concentrated in the
              Ganges Delta
            </p>
            <p className="hemp-p">
              It is also extremely affordable and is considered a very
              eco-friendly material. <br></br> The plants from which it is made
              are naturally occurring in the fertile areas along the Ganges.
            </p>
          </div>
        </div>
        ...
        <div className="wool-bottom">
          <div
            className="material-img"
            style={{ backgroundImage: 'url(/images/materials-photo/wool.jpg)' }}
          ></div>
          <h2 className="materials-h2">
            Highly sustainable and biodegradable, wool is one of the most
            recyclable fibers. We use recycled wool and Merino wool from mills
            in Italy and Australia.
          </h2>
          <div
            className="material-img"
            style={{
              backgroundImage: 'url(/images/materials-photo/wool3.jpg)'
            }}
          ></div>
        </div>
        ...
        <div>
          <div
            className="hemp-img"
            style={{
              backgroundImage: 'url(/images/materials-photo/hemp4.jpg)'
            }}
          >
            <div className="hemp-description">
              <p className="hemp-p">
                Hemp has been used to make fabric for thousands of years. It’s
                one of the most sustainable fibres in the world, and an
              ...
              <p className="hemp-p">
                ...
                <br></br> different products can currently be made with hemp.
              </p>
              <p className="hemp-p">
                WE USE HEMP THROUGHOUT OUR COLLECTIONS. ITS ADAPTABILITY MEANS
                IT’S EASY TO BLEND WITH OTHER FIBRES TO CREATE DIFFERENT FABRIC
                WEIGHTS – FOR WARMER OR COOLER CLOTHING.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="silk-images">
          <div
            className="material-img"
            style={{
              backgroundImage: 'url(/images/materials-photo/silk4.jpg)'
            }}
          >
            <div className="cotton-description">
              {' '}
          ...
          <div
            className="material-img"
            style={{
              backgroundImage: 'url(/images/materials-photo/silk3.jpg)'
            }}
          >
            <div className="cotton-description">
              Silk is not in endless supply and it is still extremely
          ...
          <div
            className="material-img"
            style={{
              backgroundImage: 'url(/images/materials-photo/silk6.jpg)'
            }}
          >
            <div className="cotton-description">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(/images/materials-photo/recycled1.jpg)'
          }}
        >
