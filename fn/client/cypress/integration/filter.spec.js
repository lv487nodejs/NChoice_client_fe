describe('filter', () => {
    ...
    it('brand filter should return Gosha brand items only', () => {
        ...
        cy.get(':nth-child(1) > .cardWrapper > .productName').should('contain', 'gosha');
    ...
    it('brand filter should return Ruma brand items only', () => {
        ...
        cy.get(':nth-child(1) > .cardWrapper > .productName').should('contain', 'ruma');
    ...
    it('brand filter should return Cassics brand items only', () => {
        ...
        cy.get(':nth-child(1) > .cardWrapper > .productName').should('contain', 'cassics');
    ...
    it('brand filter should return Tommy Kesh brand items only', () => {
        ...
        cy.get(':nth-child(1) > .cardWrapper > .productName').should('contain', 'tommy kesh');
