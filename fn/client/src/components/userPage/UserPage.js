    ...
    if (user) {
        return (
            <form onSubmit={submitHandler}>
                ...
                <InputGroup>
                    <FormControl type="email" name="email" id="email" value={userChangedData.email} placeholder="enter email..."  onChange={changeHandler}  />
                </InputGroup>
                <label htmlFor="password">change your password</label>
                <InputGroup>
                    <FormControl type="password" name="password" id="password" value={userChangedData.password}  placeholder="enter password..." onChange={changeHandler}  />
                </InputGroup>
